			...
			<form method=post action="insert_ok.do">
				<table class="table">
					...
					<tr>
						...
						<td class="text-left" width=80%><input type=text name=subject
							size=45></td>
					</tr>
					<tr>
						<th class="danger text-right" width=20%>내용</th>
						<td class="text-left" width=80%><textarea rows="10" cols="50"
								name=content></textarea></td>
					</tr>
					<tr>
						<th class="danger text-right" width=20%>비밀번호</th>
						<td class="text-left" width=80%><input type="password"
							name=pwd size=10></td>
					</tr>
					<tr>
						<td class="text-center" colspan="2"><input type="submit"
							value="글쓰기"> <input type="button" value="취소"
